...
export function nestedFields<Src extends object, K1 extends keyof Src, K2 extends keyof Src[K1], K3 extends keyof Src[K1][K2], K4 extends keyof Src[K1][K2][K3], C= any>( key1: K1, key2: K2, key3 :K3, key4: K4): FnMapper<Src, Src[K1][K2][K3][K4], C>; 
export function nestedFields<Src extends object, K1 extends keyof Src, K2 extends keyof Src[K1], K3 extends keyof Src[K1][K2], K4 extends keyof Src[K1][K2][K3], K5 extends keyof Src[K1][K2][K3][K4], C= any>( key1: K1, key2: K2, key3 :K3, key4: K4, key5: K5): FnMapper<Src, Src[K1][K2][K3][K4][K5], C>; 
export function nestedFields<Src extends object, K1 extends keyof Src, K2 extends keyof Src[K1], K3 extends keyof Src[K1][K2], K4 extends keyof Src[K1][K2][K3], K5 extends keyof Src[K1][K2][K3][K4], K6 extends keyof Src[K1][K2][K3][K4][K5], C= any>( key1: K1, key2: K2, key3 :K3, key4: K4, key5: K5, key6: K6): FnMapper<Src, Src[K1][K2][K3][K4][K5][K6], C>; 
